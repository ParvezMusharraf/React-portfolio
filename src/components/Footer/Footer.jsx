...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="icons">
        <a title="Github" href="https://github.com/ParvezMusharraf">
        ...
        <a
          title="Linkedin"
          href="https://www.linkedin.com/in/parvez-musharraf-a94533252/"
        >
      ...
      <div className="container main">
        <div className="para d-flex justify-content-center ">
          <p>
            Hello every one thanks for visiting my portfolio site i made this
            website with Love and hope that you liked it.
          </p>
        </div>
      </div>
